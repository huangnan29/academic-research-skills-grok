...
2026-09-07更新：以下为8月30日历史验收。新增实测及修改后验证见`audits/2026-09-07-grok-build/`。当前Grok适配层已修正固定披露与输出规则，并按用户明确要求直接合入main；尚未发布v0.3.1 Release，不更新全局安装。源码合入不代表全部验证通过，下文“不合并main”为当时的历史决策，已被本次用户要求取代。
