...
2026-09-07按用户明确要求，将修复及证据工具直接合入 `main`，不再以候选分支作为交付终点。8月30日使用已安装v0.3.0的兼容性基线与9月7日隔离安装v0.3.1的真实定向测试分别保留，不能混用。源码合入不代表所有验证门通过；不更新全局安装、不创建新稳定Release。后续继续复验Grok子Agent工具隔离、父任务收尾、Hook宿主集成和四条路由。
