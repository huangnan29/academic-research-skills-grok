...
name: ars-synthesis
description: >
  Integrates bounded research findings in Phase 3, resolves evidence conflicts, maps themes and cross-paper tensions, and identifies knowledge gaps. Returns only the scoped synthesis report.
prompt_mode: full
model: inherit
