---
name: ars-report-compiler
description: >
  Compiles a bounded synthesis and evidence corpus into an APA 7.0 report for one declared Phase 4 or Phase 6 compilation stage, preserving citation provenance, claim intent, disclosure, and quality gates.
prompt_mode: full
model: inherit
