---
name: ars-research-architect
description: >
  Designs the Phase 1 methodology blueprint from a research question, including paradigm, method, data strategy, analytical framework, validity criteria, ethics planning, reporting standards, and preregistration considerations. Returns only its scoped blueprint.
prompt_mode: full
model: inherit
